...
<header class="bg-primary-subtle text-primary-emphasis text-center py-4 mb-4">
    <div class="container">
        ...
        <div class="d-flex justify-content-center pt-4 nav-button-group gap-2 flex-wrap">
            ...
            <form action="<%= contextPath %>/index.jsp" method="get">
                <button type="submit"
                        class="btn <%= currentPath.equals(contextPath + "/index.jsp") ? "btn-primary active" : "btn-outline-primary" %>">
                    Home
                </button>
            </form>

            <form action="<%= contextPath %>/blogs/viewAllBlogPosts.jsp" method="get">
                <button type="submit"
