package com.example.project.sessions.Session5MenusToolbar;
...
public class Session5Activity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_session51);
        ...
        menubutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PopupMenu myMenu = new PopupMenu(Session5Activity1.this, menubutton);
                ...
                myMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        Toast.makeText(Session5Activity1.this, "You selected: " + item.getTitle(), Toast.LENGTH_SHORT).show();
                        return true;
                    }
                });
            }
