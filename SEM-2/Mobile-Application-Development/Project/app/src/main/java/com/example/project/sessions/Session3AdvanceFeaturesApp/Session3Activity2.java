...
public class Session3Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_session32);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!query.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(Session3Activity2.this, "Please enter a search query or location.", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        dial_and_wallpaper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Session3Activity2.this, Session3Activity3.class);
