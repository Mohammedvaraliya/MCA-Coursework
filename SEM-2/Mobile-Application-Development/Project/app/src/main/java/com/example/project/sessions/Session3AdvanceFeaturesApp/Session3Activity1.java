...
public class Session3Activity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_session31);
    ...
    public void onLoginButtonClick(View view) {
        ...
        if (username.isEmpty() || email.isEmpty() || password.isEmpty() || department.isEmpty()) {
            ...
            Intent intent = new Intent(Session3Activity1.this, Session3Activity2.class);
