...
public class Session8Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_session82);
        ...
        parentNodeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                dbRef = firebaseDatabase.getReference(selectedParentNode);
                Toast.makeText(Session8Activity2.this, "Now working with: " + selectedParentNode, Toast.LENGTH_SHORT).show();
            ...
            dbRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        Toast.makeText(Session8Activity2.this, "No records found", Toast.LENGTH_SHORT).show();
                    }
                }

                @Override
                public void onCancelled(DatabaseError error) {
                    Toast.makeText(Session8Activity2.this, "Error loading data", Toast.LENGTH_SHORT).show();
                }
            });
        });
            ...
            dbRef.child(id).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        Toast.makeText(Session8Activity2.this, "Record not found", Toast.LENGTH_SHORT).show();
                    }
                }

                @Override
                public void onCancelled(DatabaseError error) {
                    Toast.makeText(Session8Activity2.this, "Search failed", Toast.LENGTH_SHORT).show();
                }
            });
        });
